                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3 mt-3">
                            ...
                            <input type="description" class="form-control" id="description" value="<?= isset($_SESSION['data']) ? $_SESSION['data']['description'] : null ?>" placeholder="Enter description" name="description">
                        </div>
                    </div>
